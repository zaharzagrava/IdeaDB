...
create table knowledge_file (
  id bigserial primary key,
  src_text text,
  last_date_time_modified timestamptz,
...
values(
    '<p>Attribute describes the system</p>',
    'Attribute describes the system',
    '{"identifiers":{"system":null,"attribute":null},"discipline":{"biology":null},"year":{}}',
    timestamptz '2019-08-26 10:00:00+03',
    timestamptz '2019-08-26 10:00:00+03',
    2
  );
insert into knowledge_file(
...
values(
    '<p>System is a fundamental analysis tool</p>',
    'System is a fundamental analysis tool',
    '{"identifiers":{"system":null},"discipline":{"biology":null,"physics":null},"year":{}}',
    timestamptz '2019-08-26 10:00:00+03',
    timestamptz '2019-08-26 10:00:00+03',
    2
  );
insert into client_knowledge_file(client_id, knowledge_file_id)
values (1, 1);
insert into client_knowledge_file(client_id, knowledge_file_id)
values (1, 2);
...
select *
from knowledge_file
where knowledge_file.properties @> '{"discipline": ["biology", "physics"]}'::jsonb -- search for knowledge_file (s)
select *
from knowledge_file
where knowledge_file.properties @> '{"discipline": ["biology"], "identifiers": ["tree"], "year": ["1854"]}'::jsonb -- search for knowledge_file (s)
select *
from knowledge_file
where knowledge_file.properties @> '{"discipline": ["biology"], "identifiers": ["relation"], "year": ["1854"]}'::jsonb -- create a knowledge_file
insert into knowledge_file(
    html_text,
    plain_text,
    properties,
